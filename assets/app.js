...
const COPY = {
  en: {
    ...
    start_by_situation_title: "Start by your situation",
    start_by_situation_desc: "Choose the flow that matches your issue, then apply recommended defaults.",
    intent_card_large_title: "File is too large",
    intent_card_large_desc: "Compress for upload limits and email attachments.",
    intent_card_resize_title: "Dimensions are wrong",
    intent_card_resize_desc: "Resize width and height to required pixel values.",
    intent_card_heic_title: "HEIC not supported",
    intent_card_heic_desc: "Convert to JPG for wider compatibility.",
    intent_card_webp_title: "WEBP rejected",
    intent_card_webp_desc: "Convert to JPG or PNG based on compatibility needs.",
  ...
  es: {
    ...
    start_by_situation_title: "Empieza segun tu situacion",
    start_by_situation_desc: "Elige el flujo que coincide con tu problema y aplica valores recomendados.",
    intent_card_large_title: "El archivo es demasiado grande",
    intent_card_large_desc: "Comprime para limites de carga y adjuntos de correo.",
    intent_card_resize_title: "Las dimensiones son incorrectas",
    intent_card_resize_desc: "Ajusta ancho y alto a los pixeles requeridos.",
    intent_card_heic_title: "HEIC no es compatible",
    intent_card_heic_desc: "Convierte a JPG para mayor compatibilidad.",
    intent_card_webp_title: "WEBP es rechazado",
    intent_card_webp_desc: "Convierte a JPG o PNG segun necesidades de compatibilidad.",
  ...
  zh: {
    ...
    start_by_situation_title: "按你的问题快速开始",
    start_by_situation_desc: "选择与你问题匹配的流程，并直接使用推荐默认值。",
    intent_card_large_title: "文件太大",
    intent_card_large_desc: "为上传限制和邮件附件进行压缩。",
    intent_card_resize_title: "尺寸不符合要求",
    intent_card_resize_desc: "将宽高调整为所需像素。",
    intent_card_heic_title: "HEIC 不兼容",
    intent_card_heic_desc: "转换为 JPG 以获得更广泛兼容性。",
    intent_card_webp_title: "WEBP 被拒绝",
    intent_card_webp_desc: "根据兼容需求转换为 JPG 或 PNG。",
  ...
  ko: {
    ...
    start_by_situation_title: "상황에 맞게 바로 시작",
    start_by_situation_desc: "문제에 맞는 흐름을 고르고 추천 기본값으로 진행하세요.",
    intent_card_large_title: "파일 용량이 너무 큼",
    intent_card_large_desc: "업로드 제한과 이메일 첨부를 위해 압축합니다.",
    intent_card_resize_title: "크기가 맞지 않음",
    intent_card_resize_desc: "가로/세로를 필요한 픽셀로 조정합니다.",
    intent_card_heic_title: "HEIC 미지원",
    intent_card_heic_desc: "호환성을 위해 JPG로 변환합니다.",
    intent_card_webp_title: "WEBP 업로드 거부",
    intent_card_webp_desc: "호환성에 맞춰 JPG 또는 PNG로 변환합니다.",
  ...
  ja: {
    ...
    start_by_situation_title: "状況に合わせて開始",
    start_by_situation_desc: "問題に合うフローを選び、推奨設定ですぐ進めます。",
    intent_card_large_title: "ファイルサイズが大きすぎる",
    intent_card_large_desc: "アップロード制限やメール添付向けに圧縮します。",
    intent_card_resize_title: "サイズが合わない",
    intent_card_resize_desc: "幅と高さを必要なピクセルに調整します。",
    intent_card_heic_title: "HEIC が非対応",
    intent_card_heic_desc: "互換性のために JPG に変換します。",
    intent_card_webp_title: "WEBP が拒否される",
    intent_card_webp_desc: "互換性に応じて JPG または PNG に変換します。",
